...
![A showdown in progress: two playmats facing each other across the
battlefields, with the log showing a trigger going onto the chain and
resolving](docs/board.webp)
